...
static unsigned long mouse_foreground = 0xff;
static unsigned long mouse_background = 0;
...
long CDECL c_mouse_draw(Workstation *wk, long x, long y, Mouse *mouse)
{
    ...
    {                                   /* New mouse shape */
        ...
        if (*pp != mouse_old_colours)
        {
            ...
            mouse_foreground = x_get_colour(wk, (*pp >>  0) & 0xffff);
            mouse_background = x_get_colour(wk, (*pp >> 16) & 0xffff);
        }
